<template>
  <div class="text-center w-[350px] my-auto mx-auto h-[538px]">
    ...
    <div class="grid col-auto text-[#929292] mb-5">
      <span class="font-iransensUltralight">لطفاً ایمیل خود را وارد کنید</span>
    </div>
    <form
      @submit="checkForm"
...
document.body.className =
  "bg-[#212121] overflow-hidden flex justify-center items-center w-[100vw] h-[100vh]";
...
const checkForm = async e => {
  ...
  if (regex.test(emailValue.value)) {
    ...
    e.preventDefault();
    await fetch("http://telegrammeli.amirmohammadgharibi.ir/users/send-code",{
      method: "POST",
      headers: {
